/**
 * We knew we did a day class for homework once. And in our reservation class we needed a way to calculate days between
 * 		so we borrowed this class to help us accomplish our task. And now we are giving it credit.
 * 
 * @author CSC2100
 *
 */
...
public class Day
{
   ...
   */
   ...
   public String toString() {
	  String day = getMonth() +"/" +getDate() +"/" +getYear();
